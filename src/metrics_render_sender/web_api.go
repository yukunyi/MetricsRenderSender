...
var explicitWebSnapshotLabels = map[string]string{
	...
	"go_native.btrfs_root.device_size":         "Btrfs root device size",
	"go_native.btrfs_root.allocated":           "Btrfs root allocated",
	...
	"go_native.btrfs_root.pinned":              "Btrfs root pinned",
	"go_native.btrfs_root.reclaim":             "Btrfs root reclaim",
	"go_native.btrfs_root.discardable":         "Btrfs root discardable",
	"go_native.zram.count":                     "Zram device count",
	"go_native.zram.size":                      "Zram size",
	"go_native.zram.data":                      "Zram data",
	"go_native.zram.compressed":                "Zram compressed data",
	"go_native.zram.memory_used":               "Zram memory used",
	"go_native.zram.memory_peak":               "Zram memory peak",
	"go_native.zram.usage":                     "Zram usage",
	"go_native.zram.memory_usage":              "Zram memory usage",
	"go_native.zram.compression_ratio":         "Zram compression ratio",
	"go_native.zram.allocator_usage":           "Zram allocator usage",
	"go_native.zram.pages_compacted":           "Zram pages compacted",
	"go_native.zram.huge_pages":                "Zram huge pages",
	"go_native.zram.huge_pages_since":          "Zram huge pages since setup",
